            ...
            <div className="container mx-auto px-4 lg:px-20 flex justify-between items-center">
                ...
                <div className="hidden lg:flex items-center gap-8">
                    ...
                    <div className="relative inline-block">
                        {/* Resume Button */}
                        <a
                            href={isPremium ? "https://career-genie-resume-client.vercel.app/" : "#"}
                        ...
                        {!isPremium && (
                            <div
                                ...
                                className="absolute inset-0 flex items-center justify-center bg-white/50 rounded cursor-pointer"
                            >
                        ...
                        <li>
  <a href="/roadmap" className="text-yellow-400 hover:text-yellow-500">
    Career Roadmap
  </a>
</li>
            ...
            {menuOpen && (
                <div className="lg:hidden bg-gradient-to-br from-[#1b07f6] to-[#4a00e0] text-white flex flex-col gap-3 p-4 mt-2 rounded-lg shadow-lg animate-slide-down">
                    <Link
                        to="/applications"
                        className="nav-item px-4 py-2 rounded-md transition-all duration-300 hover:bg-white hover:text-blue-700"
