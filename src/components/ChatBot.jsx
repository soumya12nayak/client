...
const ChatBot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/api/chat", { messages: finalMessages });
    // await axios.post("https://career-genie-server.vercel.app/api/chat", { messages: finalMessages });
